 ...
 *
 * SQLite note: JSONB → json, INET → string(45), TEXT[] → json,
...
exports.up = async function (knex) {
  ...
  await knex('roles').insert([
    ...
    { name: 'user',       description: 'Standard user',         permissions: JSON.stringify(['profile:read', 'profile:write']),     is_system: true },
  ])
